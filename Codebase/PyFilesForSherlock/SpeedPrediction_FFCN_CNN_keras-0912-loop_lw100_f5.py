...
input_window_size = 106 # number of timestamps used in the input for prediction (i.e. the input window)
label_window_size = 100 # number of timestamps used to label the speed we will be predicting
